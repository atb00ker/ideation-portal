...
import LikeIconFilled from '../../assets/icons/bootstrap-thumbs-up-fill.svg';
        ...
        <Row>
          ...
          <Col xs={12} className="m-auto max-width-960">
            ...
            <Button style={{ padding: 0 }}>
              <a className="button-href" href={topicData.topics_by_pk.link}
                target="_blank" style={{ lineHeight: '38px', padding: '10px' }}>More Information
                   <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 2 24 24" width="16px" fill="#ffffff"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"/></svg>
              </a>
            </Button>
          ...
          <Col xs={12} className="mb-5 m-auto max-width-960">
            ...
            <Badge bg="info">
              Last updated : {new Date(topicData.topics_by_pk.updated_at).toLocaleDateString("en-US", dateFormatOptions)}
            </Badge>
          </Col>
        </Row>
      </Container>
